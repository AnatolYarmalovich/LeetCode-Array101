...
//        var firstIndex = 0
//        var secondIndex = 1
//        while nums[firstIndex] + nums[secondIndex] != target || firstIndex == secondIndex {
//            if secondIndex == nums.count - 1  {
//                secondIndex = 0
//                firstIndex += 1
//            } else if firstIndex == nums.count - 1 {
//                firstIndex = 0
//            }
//            else {
//                secondIndex += 1
...
//        print("Actual: \(actual), Expected: \(expected), Test passed: \(condition)")
//        assert(condition)
//    }
//
//    func secondTestCase() {
//        let actual = twoSum([3,2,4], 6)
//        let expected = [1, 2]
//        let condition = actual == expected
//        print("Actual: \(actual), Expected: \(expected), Test passed: \(condition)")
//        assert(condition)
...
//print(Solution().thirdTestCase())
//print(Solution().fourthTestCase())
